 ...
 * Class Locations
 *
 * Contains static data for country, continent, currency, and flag information.
 */
class Locations {

	/** @var array Continent data */
...
Saint Eustatius and Saba ",
	...
	/**
	 * Get continent info from country code
	 *
	 * @param string $code Country code
	 *
	 * @return array|null
	 */
	public static function get_continent( string $code ): ?array {
	 ...
	 * @return array|null
	 */
	public static function get_currency( string $code ): ?array {
		return self::CURRENCIES[ $code ] ?? null;
	}

	/**
	 * Get flag info from country code
	 *
	 * @param string $code Country code
	 *
	 * @return array|null
	 */
	public static function get_flag( string $code ): ?array {
